...
HD_PWD='C:/BC_Final_Project/hdl/projects/FIR_Filter_Design/FIR_Filter_Design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_Lowpass_Filter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR_Lowpass_Filter.tcl -notrace
