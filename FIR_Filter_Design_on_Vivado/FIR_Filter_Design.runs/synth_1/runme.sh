...
HD_PWD='C:/BC_Final_Project/hdl/projects/FIR_Filter_Design/FIR_Filter_Design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_Lowpass_Filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_Lowpass_Filter.tcl
