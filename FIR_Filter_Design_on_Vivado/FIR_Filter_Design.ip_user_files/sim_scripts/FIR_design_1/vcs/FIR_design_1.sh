...
design_libs=(xbip_utils_v3_0_11 axi_utils_v2_0_7 xbip_pipe_v3_0_7 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 xbip_dsp48_wrapper_v3_0_5 xbip_dsp48_addsub_v3_0_7 xbip_dsp48_multadd_v3_0_7 dds_compiler_v6_0_23 xil_defaultlib c_reg_fd_v12_0_7 xbip_addsub_v3_0_7 c_addsub_v12_0_16 sim_clk_gen_v1_0_3)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.FIR_design_1 xil_defaultlib.glbl -o FIR_design_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./FIR_design_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key FIR_design_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc FIR_design_1_simv.daidir vcs_lib c.obj)
